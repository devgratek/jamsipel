<!-- Messages: style can be found in dropdown.less-->
                        <li class="dropdown messages-menu">
                            <a href="#" class="dropdown-toggle" title="This module is desable">
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" title="this module is disable"><!-- data-toggle="dropdown" -->
                        ...
                        <li class="dropdown tasks-menu">
                            <a href="#" class="dropdown-toggle" title="This module is desable"> <!-- data-toggle="dropdown" -->
